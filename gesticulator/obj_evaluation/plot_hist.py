...
feature_filename = 'result/Full_3d/hmd_' + type + '_0.05.csv'
_, full_model = read_csv(feature_filename)

"""
# Get No Autoregr
_,no_autoregr = read_csv('result/No_autoregr_3d/hmd_' + type + '_0.05.csv')

# Get No FiLM
_,no_FiLM = read_csv('result/No_FiLM_3d/hmd_' + type + '_0.05.csv')

# Get No Speech
_,no_speech = read_csv('result/No_speech_3d/hmd_' + type + '_0.05.csv')

# Get No Text
_,no_Text = read_csv('result/No_Text_3d/hmd_' + type + '_0.05.csv')

_,no_Vel_pen = read_csv('result/No_Vel_pen_3d/hmd_' + type + '_0.05.csv')

_,no_PCA = read_csv('result/NoPCA_3d/hmd_' + type + '_0.05.csv')
"""
...
plt.xlabel("Acceleration ($cm$/$s^2$)", size=50)

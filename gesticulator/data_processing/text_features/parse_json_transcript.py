...
def encode_json_transcript_with_bert(json_file, tokenizer, bert_model):
    ...
    filler_sentence = ' '.join(fillers)
    # The filler encoding is the embedding vector of 'eh' in the sentence
    filler_encoding = get_bert_embedding(filler_sentence, tokenizer, bert_model)[0]
    delimiters = ['.', '!', '?']
    ...
    for segment in transcription_segments: 
        ...
        for word_data in segment_words:                
            ...
            if is_sentence_over:
                ...
                encoded_words = get_bert_embedding(sentence, tokenizer, bert_model)
...
def get_bert_embedding(sentence, tokenizer, bert_model):
    ...
    encoded_words = encoded_words[1:-1]
